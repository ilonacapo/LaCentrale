...
class Project
{
    ...
    #[ORM\OneToMany(mappedBy: 'project', targetEntity: Branch::class, cascade: ['persist', 'remove'])]
    private Collection $branches;

    #[ORM\OneToMany(mappedBy: 'project', targetEntity: Tag::class, cascade: ['persist', 'remove'])]
